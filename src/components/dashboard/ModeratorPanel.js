  ...
  return (
    <div>
      ...
      <div className="mb-5 p-4 bg-brand-50 border border-brand-100 rounded-xl">
        <p className="text-sm font-semibold text-brand-700">🛡️ Moderator Paneli</p>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    💰 ₼{Number(product.price).toFixed(2)} · 📦 {product.stock} ədəd
                  </p>
                  {product.seller && (
                    <p className="text-xs text-gray-400 mt-0.5">👤 {product.seller.fullName}</p>
                  )}
