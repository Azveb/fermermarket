      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-50 via-white to-green-50 border border-green-100 p-6 md:p-8">
        ...
        <div className="relative flex flex-col md:flex-row items-start md:items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-xl md:text-2xl font-extrabold text-gray-900 mb-1">AI Aqronom</h2>
            <p className="text-gray-600 text-sm max-w-sm">
              Bitkinizdə xəstəlik var? Şəkil göndərin, AI analiz etsin. Torpaq, məhsul, iqlim haqqında sual verin.
            </p>
