      ...
      <div className="hidden md:block border-t border-gray-100 bg-white">
        <div className="max-w-6xl mx-auto px-4 h-11 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-11 h-11 flex items-center justify-center rounded-[14px] border border-gray-200 bg-white shadow-sm text-gray-500 hover:border-[#0A66C2] hover:bg-[#0A66C2]/5 hover:text-[#0A66C2] hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" className="group-hover:scale-110 transition-transform duration-300"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg>
            </a>
            {/* WhatsApp */}
