...
export default function BrandDetailPage() {
  ...
  if (loading) {
    return <div className="max-w-6xl mx-auto px-4 py-20 text-center text-gray-400">Yüklənir...</div>;
  }
  ...
  if (!brand) {
    return (
      <div className="max-w-6xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-gray-500">Brend tapılmadı</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {/* Products */}
      <h2 className="text-xl font-bold text-gray-900 mb-4">{brand.name} məhsulları</h2>
